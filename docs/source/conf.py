# -*- coding: utf-8 -*-
""" Sphinx configuration for aiida-lsmo
...
release = aiida_lsmo.__version__
...
html_use_opensearch = 'http://aiida-lsmo.readthedocs.io'
...
htmlhelp_basename = 'aiida-lsmo-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_lsmo')
